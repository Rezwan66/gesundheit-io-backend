...
const getStatusCodeFromPrismaError = (errorCode: string): number => {
  ...
  //P6009: Response size limit exceeded => 413 Request Entity Too Large
  if (errorCode === 'P6009') return status.REQUEST_ENTITY_TOO_LARGE || 413;

  //P1XXX, P2024, P3037, P6008: Connection errors => 503 Service Unavailable
  ...
  //P3XXX, P4XXX: except unhandled errors, internal server error
